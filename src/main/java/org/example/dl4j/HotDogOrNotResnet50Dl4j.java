...
public class HotDogOrNotResnet50Dl4j {
    ...
    private static final String TRAINING_DATASET = "/Users/i538649/IdeaProjects/java-ml/src/main/resources/dataset/train";
    private static final String TESTING_DATASET = "/Users/i538649/IdeaProjects/java-ml/src/main/resources/dataset/test";
    ...
    public static void transferLearningResnet50() throws IOException {
        ...
        ComputationGraph resnet50Transfer = new TransferLearning.GraphBuilder(resnet)
                ...
                .setOutputs(
                        "newpredictions") //since we removed the output vertex and it's connections we need to specify outputs for the graph
                .build();
        ...
        for (int i = 1; i < 3 + 1; i++) {
            ...
            if (resnet50Transfer.score() < lowest) {
                ...
                String modelFilename = new File(".").getAbsolutePath() + "/HotDogsClassifier_loss" + lowest + "_ep" + i + "ResNet50.zip";
